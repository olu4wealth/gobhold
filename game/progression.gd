...
const NODES := [
	...
	{"id": "auto", "name": "AUTOMATIC MISSILE", "category": "ability", "position": Vector2(790, -430), "desc": "A milestone that fires emergency rockets automatically at the cursor.", "max": 1, "costs": [{"crystals": 2}], "needs": ["missile_cd"], "requires_level": {"missile_cd": 8}, "effect": {"kind": "auto"}},
